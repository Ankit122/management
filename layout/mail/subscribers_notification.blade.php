...
------------------------------------- */
h1,h2,h3,h4,h5,h6 {
font-family: "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; line-height: 1.1; margin-bottom:15px; color:#db4a39;   
}
...
<body bgcolor="#FFFFFF" style="margin:0 auto; margin-left:0px;">
	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						...
						<p style="padding:15px; background-color:#474747; margin-bottom: 15px;color:#fff; font-size:20px;">
							Yours subscription is accpected..
						</p><!-- /Callout Panel -->
                ...
                Email: <strong><a href="emailto:info@kbf.org" style="text-decoration: underline;">info@kamsarobar.org</a></strong></p>
