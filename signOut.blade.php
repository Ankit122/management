 ...
 <head>
  ...
  <div class="inner-container">
    ...
    <div class="box">
      ...
      <form class="form-group" method="POST" action="{{url('signOut')}}">
      <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
      <input type="hidden"  id="system_time_signout" name="system_time_signout">
      <input type="text"  name="empsignout_id" value="{{old('empsignout_id')}}" placeholder="Employee ID" id="empsignout_id" maxlength="10" />
      <button type="submit" href="{{URL('logout')}}">Logout</button>
      </form>
    </div>
  </div>
</div>
